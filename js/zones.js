...
export const ZONES = {
    pradera: {
        ...
        background: 'bg_pradera', defaultBiome: 'GRASS',
    ...
    desierto: {
        ...
        background: 'bg_desierto', defaultBiome: 'DESERT',
    ...
    bosque_rio: {
        ...
        background: 'bg_bosque_rio', defaultBiome: 'GRASS',
    ...
    montanas_nevadas: {
        ...
        background: 'bg_montanas_nevadas', defaultBiome: 'SNOW',
    ...
    cementerio_animales: {
        ...
        background: 'bg_cementerio_animales', defaultBiome: 'DESERT',
